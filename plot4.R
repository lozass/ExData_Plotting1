...
plot(b$dateTimePOSIX, b$Voltage, type = "l", ylab ="Voltage", xlab="datetime")
...
plot(b$dateTimePOSIX, b$Global_reactive_power, xlab="datetime", ylab="Global_reactive_power", type="l")
dev.off()
